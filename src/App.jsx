...
function PortalsPage(){
  ...
  return(<div style={{minHeight:"100vh",background:"#000",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",paddingTop:HEADER_H-20}}>
    <style>{`@keyframes portalOpen{0%{opacity:0;clip-path:ellipse(0% 0% at 50% 50%);filter:blur(14px) brightness(1.3)}8%{opacity:1;clip-path:ellipse(22% 0.6% at 50% 50%);filter:blur(11px) brightness(1.5) contrast(1.2)}18%{opacity:0.85;clip-path:ellipse(40% 1.5% at 50% 50%);filter:blur(9px) brightness(1.3)}28%{opacity:1;clip-path:ellipse(52% 5% at 50% 50%);filter:blur(7px) contrast(1.15)}40%{opacity:0.92;clip-path:ellipse(60% 14% at 50% 50%);filter:blur(5px)}52%{opacity:1;clip-path:ellipse(68% 28% at 50% 50%);filter:blur(4px)}64%{opacity:0.96;clip-path:ellipse(74% 42% at 50% 50%);filter:blur(3px)}76%{opacity:1;clip-path:ellipse(82% 58% at 50% 50%);filter:blur(2px)}88%{opacity:1;clip-path:ellipse(92% 75% at 50% 50%);filter:blur(1px)}100%{opacity:1;clip-path:ellipse(130% 130% at 50% 50%);filter:blur(0) brightness(1) contrast(1)}}@keyframes portalLine{0%{opacity:0;width:0%}10%{opacity:0.9;width:45%}25%{opacity:0.6;width:80%}50%{opacity:0.35;width:90%}75%{opacity:0.15;width:70%}100%{opacity:0;width:40%}}@keyframes captionRise{0%{opacity:0;transform:translateY(8px)}100%{opacity:1;transform:translateY(0)}}`}</style>
    <div style={{position:"relative",width:"min(80vw,500px)",height:"min(80vw,500px)"}}>
      <div ref={mountRef} style={{width:"100%",height:"100%",position:"relative",opacity:loaded?undefined:0,animation:loaded?"portalOpen 1s cubic-bezier(0.22,1,0.36,1) both":undefined}}/>
      {loaded&&<div style={{position:"absolute",left:"50%",top:"50%",height:1.5,background:"linear-gradient(90deg,transparent,rgba(74,246,38,0.85) 35%,rgba(0,255,213,0.95) 50%,rgba(74,246,38,0.85) 65%,transparent)",boxShadow:"0 0 10px rgba(74,246,38,0.6),0 0 22px rgba(0,255,213,0.35)",pointerEvents:"none",transform:"translate(-50%,-50%)",animation:"portalLine 1s cubic-bezier(0.22,1,0.36,1) both",mixBlendMode:"screen"}}/>}
    </div>
