...
const PIECE_EV={"Tomomi Adachi, Hannah Silva — Pluto is a planet! (2018), live performance for voice, electronics, sensor-based interaction and a participatory choir":52,"Claudio Ambrosini — Incipit (2017) for ensemble":52,"Samuel Andreyev — Cosa arcana e stupenda (2017) for ensemble":110,"Anonymous — The Nightingale (13th–14th c.)":16,"Anonymous — Tu solus Dominus (10th–12th c.)":16,"Luca Antignani — Cosa Arcana (2017) for ensemble":110,"Mkhitar Ayrivanetsi — liturgical monody (c. 1235–1297/1300)":78,"Pierre Bastien — Playing with the Dead (2014), live performance for self-built mechanical instruments, trumpet, and video":43,"BEAMSPLITTER (Audrey Chen and Henrik Munkeby Nørstebø) — Medea in the Gardens of the Hesperides, an improvised electroacoustic performance accompanied by a visual project of Lisa Biletska":170,"Johann Strauss II / arr. Alban Berg — Wein, Weib und Gesang, Op. 333 (1921) for string quartet and piano":5,"Luciano Berio — Points on the Curve to Find… (1974) for piano and chamber orchestra":12,"Lisa Biletska — Medea in the Gardens of the Hesperides (2023), digital diptych":170,"Katya Buchatska — Lethe (2018), audiovisual installation":135,"William Byrd — John, Come Kiss Me Now (late 16th–early 17th c.)":42,"Carmine Emanuele Cella — Pane, Sale, Sabbia (2017), an opera to the libretto by Rossano Baronciani":116,"Audrey Chen, Phil Minton, Henrik Munkeby Nørstebø, Thomas Rohrer, Michael Vorfeld — Medea (2016), an improvised butoh opera with Valentin Tszin, Flavia Ghisalberti, Poema Theatre, and thirty butoh dancers":96,"Audrey Chen, Henrik Munkeby Nørstebø — .AVI 3 (2015), an audiovisual improvisation with butoh dancers Flavia Ghisalberti and Valentin Tszin":70,"Montpellier Codex — Alle psallite cum luya (13th c.)":65,"Montpellier Codex — Amor potest conqueri (13th c.)":65,"Montpellier Codex — Huic ut placuit (13th c.)":65,"Antonio Correa — 5 Short pieces (2013) for piano":33,"Federico Costanza — Nel vortice così come nel nervo (2017) for ensemble":110,"François Couturier — The Man Who Saw The Angel (2008) for chamber orchestra":110,"François Couvreur — Cosa Arcana e stupenda (2017) for ensemble":110,"Peter Cusack — Sounds from Dangerous Places (2012), audioinstallation":92,"Gualtiero Dazzi — Cosa arcana (2017) for ensemble":110,"Jacopo Facchini, Michele Foresi — Site-responsive piece for Sasha Kutovyi's A Good Man Hard to Find (2017), for voice and electronics":126,"Jacopo Fachini — electroacoustic vocal intervention within Oleksandr Kutovyi's installation":126,"Konstantia Gourzi — Beauty (2017) for ensemble":110,"Uliana Horbachevska, Mark Tokar, Petras Vyšniauskas, Klaus Kugel — Ultramarine (2012), live improvisation":19,"Baudouin de Jaer — Adolf Wölfli's Musical Cryptograms (2015), lecture-concert":74,"Daan Jansens — …qui me réduit au silence (2017) for ensemble":110,"Isaac de Judea, Olga Ostroverkh, Pavlo Kosenko, Oleksiy Khokhun — Cante Chico: cante de fiesta in dialogue with the teachings of Rabbi Nachman of Breslov":178,"Giya Kancheli — A little Daneliade (1996) for violin, piano and strings":14,"Giya Kancheli — Abii ne Viderem (1992) for string orchestra and viola":14,"Maxim Kolomiiets — Paths of the Rejected: four movements from the cantata (2015), for female choir, solo soprano, and chamber orchestra":86,"Maxim Kolomiiets — Prolegomena to an Opera: Songs for Kyiv Mohyla Academy (2025) to the texts by Sasha Andrusyk, for three singers and ensemble":179,"Dariia Kuzmych — Map of Exit from the Body of the City (2018), mixed-media exhibition":135,"Katya Libkind, Sasha Andrusyk, Mykhailo Bogachov, FORMA — Subsoil Assets (Korysni kopalyny): An exhibition of operas in the pavilion of memories (2021), based on recordings of operas by Salvatore Sciarrino, Carmine Emanuele Cella, and Stefano Gervasoni":149,"Katya Libkind, Sasha Andrusyk — Bad Trips (Everyday) — A Collective Exhibition with Mothers (performative intervention)":128,"Svyatoslav Lunyov — Bad Tempered Songs (1994), mono-opera for voice and chamber orchestra, to texts by Lewis Carroll":30,"Viktor Marushchenko — Valentyn Silvestrov: An adjacent frame (2017), documentary installation built from previously unseen footage":122,"Arturs Maskats — Concerto Grosso (1996) for violin, cello, percussion, and string orchestra":27,"John Lennon / Paul McCartney (arr. Toby Twining) — Eleanor Rigby (1966/2002) for toy piano and toy instruments":3,"Phil Minton, Audrey Chen — Site-responsive vocal improvisation (2015, Museum of Natural History, Kyiv)":55,"Florian Mosch — Litanies nocturnes (2017) for ensemble":110,"Grigor Narekatsi — Liturgical monody (951–1003)":78,"Dmytro Pashinsky — Cosa Arcana e Stupenda (2017) for ensemble":110,"Victoria Poleva — Ars Moriendi: 18 songs for an actor who sings (1983–2012) for voice and piano":14,"Victoria Poleva — Gagaku: Tadashi Endo's solo butoh performance to the recording of the piece (2012)":14,"Antonio Politano — …del suono, i suoi sublimi inganni… (2017) for ensemble":110,"Nataliia Polovynka, Slovo i Holos (Word and Voice) — IRMOS. Rejoice: Chants to the Mother of God, the Chief of Chiefs (2014)":46,"Natalia Pschenitschnikova — Voice of Zangezi (2018), mono-opera set to a text by Velimir Khlebnikov, for soprano and electronics":144,"Jaan Rääts — Bagatelles Nos. 3, 4, 8, 15, 22, Op.50 (1973), for piano":83,"Jaan Rääts — 24 Estonian Preludes, Op.80 (1988–89), for piano":83,"Jaan Rääts — Marginalia Nos. 1 and 19, Op.65 (1979–80), for piano":83,"Jaan Rääts — Piano Sonata No. 1, Op.11 No.1 (1959), for piano":83,"Jaan Rääts — Piano Sonata No. 3, Op.11 No.3 (1959), for piano":83,"Jaan Rääts — Piano Sonata No. 9, Op.76 (1985; rev. 2014), for piano":83,"Jaan Rääts — Piano Sonata No. 10, Op.114 (2000), for piano":83,"Jaan Rääts — Prelude No. 4, Op.33 (1968), for piano":83,"Jaan Rääts — Prelude, Op.128 (2014), for piano":83,"Jaan Rääts — Toccata (1968), for piano":83,"Jaan Rääts — Variations, Op.6 (1958), for piano":83,"Dmytro Radzetsky, Ukrainian Improvisers Orchestra — .AVI II (2015), a live improv with contingent scenography by Katya Libkind and Olga Gaidash":69,"Filip Rathé — El agua y la muerte (2014), Avec diamants extrêmes (2009–2019) for ensemble":110,"Filip Rathé — La fiamma vitale (2017) for ensemble":110,"Thomas Ravenscroft — Come Drink to Me (1609)":96,"Nick Roth, Olesya Zdorovetska, Fulvio Sigurtà, Alex Roth, Jack McMahon — .AVI: I (2015), audiovisual improvisation with live drawing by Jenya Tchaikovska":68,"Nick Roth, Olesya Zdorovetska, Lauren Kinsella, Simon Roth, Mark Tokar — Happy New Ears (2012), a live improv":6,"Monk of Salzburg — Martin, lieber Herre (14th c.)":80,"Mark-Andreas Schlingensiepen — Cosa arcana e stupenda (2017) for ensemble":110,"Johann Strauss II / arr. Arnold Schoenberg — Rosen aus dem Süden, Op. 388 (1921) for string quartet and piano":5,"Johannes Schöllhorn — Dias, koloriert (2010) for chamber ensemble (drei neue Anamorphosen nach der Kunst der Fuge von J.S. Bach)":58,"Salvatore Sciarrino — Vanitas. Natura morta in un atto (1981), mono-opera for mezzo-soprano, cello, and piano":158,"Alexander Scriabin — Vers la Flamme, Op. 72 (1914) for piano":34,"Alexey Shmurak — Liebestod (2024), quadraphonic audio installation developed from Liebestod album material":163,"Alexey Shmurak, Oleh Shpudeiko — Liebestod (2022) for voice, piano, harpsichord, and electronics, set to texts by Ivan Mazepa, Volodymyr Svidzinsky, Inger Christensen, and John Keats":163,"Alexey Shmurak, Oleh Shpudeiko — Orange Songs: Sound Theatre (2016) for voice, piano, electric guitar, toy instruments and computer":111,"Alexey Shmurak, Oleh Shpudeiko, with Dariia Kuzmych — The Glass Bead Game (2014), an audiovisual performance":35,"Alexey Shmurak, Oleh Shpudeiko, with Vira Marchenko — Solovey (2018), multimedia performance engaging voice, speech, song, sign, space, and meditation":174,"Alexey Shmurak, Oleh Shpudeiko, Mark Buloshnikov — Around Silvestrov (2017), live performance for voice, pianos and electronics":120,"Oleh Shpudeiko (Heinali), Volodymyr Shpudeiko — Synthtap performance using modular synthesis (2017)":127,"Oleh Shpudeiko (Heinali) — Kyiv Eternal (2023), audiovisual installation with visuals by Kachna Baraniewicz and Maryna Osnach":174,"Valentyn Silvestrov — Maidan 2014, choral cantata":89,"Valentyn Silvestrov — Drama: Sonata (1970) for violin and piano":122,"Marion Sinclair — Kookaburra sits in the old gum tree (1932)":3,"Ian Spektor, Max Werner, Alexey Gnedenko — Noisy Intro (2022), a live electroacoustic performance":160,"Ian Spektor — Death in June (2024), audio installation":173,"Elena Subach — LIMBO (2024), a pop-up exhibition":177,"Vasyl Tkachenko — In dialogue with Nazar Stets (2024), visual project (painting and video)":171,"Kazuki Tomokawa — The Voice of the Screaming Soul (2016), for voice and acoustic guitar, solo live":94,"ujif_notfound, Alisa Haspyd, Yevhen Ulianov — Lotto-cola, Mid-Devourers, and Other Stories in the Dark (2024), live electroacoustic performance based on texts by Halyna Tkachuk":165,"Ying Wang — Illuminations (2022) for piano, voice, and electronics":176,"Johann Strauss II / arr. Anton Webern — Schatz-Walzer, Op. 418 (1921) for string quartet and piano":5,"Ruth Wiesenfeld — Oscuro (2016) for large ensemble":110,"Iannis Xenakis — Jalons (1986) for fifteen musicians":118,"Iannis Xenakis — Échange (1989) for bass clarinet and ensemble":118,"Ihor Zavhorodnii — Cosa arcana e stupenda (2017) for ensemble":110};
const ANIM_MS=400;
...
function ListPage({events,onOpenEvent,idxRef,searchRef,yearRef,modeRef,scrollRef,progTermsRef}){
  ...
  const filtered=useMemo(()=>{
    ...
    if(search.trim()){
      if(progTerms){
        const{raw}=progTerms;const hc=PIECE_EV[raw];if(hc){list=list.filter(e=>e.id===hc)}else{
          // Composer + title fuzzy fallback — handles canonical PROGRAMS strings
          // whose event.pr rows are formatted differently (composer header + timed
          // pieces, abbreviated titles, separate composer/title lines, etc).
          const simpN=s=>norm(s).replace(/[^a-z0-9\u0400-\u04ff ]+/g," ").replace(/\s+/g," ").trim();
          const dashM=raw.match(/\s[—–]\s/);
          let composer="",title="";
          if(dashM){composer=raw.slice(0,dashM.index).trim();const rest=raw.slice(dashM.index+dashM[0].length).trim();title=rest.split(/\s*\(/)[0].split(/\s+for\s+/i)[0].trim();}
          const nc=simpN(composer),nt=simpN(title);
          const words=nt.split(" ").filter(w=>w.length>2);
          const shortT=words.slice(0,3).join(" ");
          list=list.filter(e=>{const joined=e.pr.map(p=>simpN(p)).join(" | ");if(nc&&nt&&joined.includes(nc)&&joined.includes(nt))return true;if(nc&&shortT&&joined.includes(nc)&&joined.includes(shortT))return true;return false;});
        }
      }else{
