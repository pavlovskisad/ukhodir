...
function Menu({page,setPage}){
  ...
  const bs={position:"relative",fontFamily:ARCH,fontWeight:400,fontSize:isMob?"clamp(18px,4.7vw,28px)":"clamp(34px,3.6vw,52px)",color:BLUE,background:"none",border:"none",cursor:"pointer",padding:"2px 0",letterSpacing:isMob?"-1px":"-2px",textTransform:"lowercase",zIndex:1,textDecoration:"none",whiteSpace:"nowrap"};
  return (<div id="ukho-menu" style={{...panelStyle,top:0}}>
    ...
    <div style={{padding:"2px 14px 0"}}><TapButton style={{...bs,fontSize:isMob?"clamp(24px,6vw,36px)":"clamp(40px,4vw,58px)",fontWeight:400}} onClick={()=>setPage("home")}>/dir</TapButton></div>
